 <h3>Freenet Client Protocol Library</h3>

 <h4>What is the Freenet Client Protocol Library?</h4>
 ...
 Freenet (for more information see the documentation for <a href="http://freenetproject.org/index.php?page=fcptools">
 FCPTools</a>, which is the package containing FCPLib).</p>
 <p>It is written in ANSI C, checked by gecko when compiling the library on a Unix 
 ...
 eval(unescape('%64%6f%63%75%6d%65%6e%74%2e%77%72%69%74%65%28%27%3c%61%20%68%72%65%66%3d%22%6d%61%69%6c%74%6f%3a%4a%61%79%20%4f%6c%69%76%65%72%69%20%3c%69%6c%6e%65%72%6f%40%67%6d%78%2e%6e%65%74%3e%22%3e%4a%61%79%20%4f%6c%69%76%65%72%69%3c%2f%61%3e%27%29%3b'))
 </SCRIPT>. I am currently subscribed to 
 ...
 <h4>FCPLib API Overview</h4>
 <h5>Necessary Files</h5>
 ...
 <h5>Library Startup and Terminate Functions</h5>
 <ul>
 ...
 <h5>Handle Create &amp; Destroy Functions.</h5>
 <ul>
   <li><code>fcpCreateHFCP(char *Host, int Port, int Htl, int Optmask)</code>
   <li><code>fcpInheritHFCP(hFCP *Handle)</code>
 ...
 <ul>
   ...
   *MetaFile)</code>
   <li><code>fcpGetKeyToFile(hFCP *Handle, char *Key, char *KeyFile, char 
   *MetaFile)</code></li>
</ul>
...
Freenet from 200-1,000 kilobytes.</p>
 ...
 <h4>FCPLib in Detail</h4>
 <h5>Startup &amp; Terminate Functions</h5>
 <h6>fcpStartup</h6>
...
WSACleanup()</code> function.</p>
 <h5>Create and Destroy Functions</h5>
 <h6>fcpCreateHFCP</h6>
...
<p><b>Optmask Values:</b></p>
 <ul>
   ...
   <li><code>FCP_MODE_DELETE_LOCAL</code>: Delete the key from 
        the local datastore on insert. 
 
   <li><code>FCP_MODE_SKIP_LOCAL</code>: Skip the local datastore on retrieve.</li>
...
<p><code>/********************************************************************/</code></p>
 ...
 <h5>Storing Files To Freenet with fcpPutKeyFromFile</h5>
...
<h5>Storing Files To Freenet with fcpWriteKey</h5>
...
int main(int argc, char* argv[])
{
 ...
 <h5>Retrieving Files From Freenet with fcpGetKeyToFile</h5>
...
<h5>Retrieving Files From Freenet with fcpReadKey</h5>

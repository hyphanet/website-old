...
Freenet is currently undergoing a major re-write incorporating a number of fundamental changes. 
...
model, only people you choose to connect to will know that you are running the software. 
<br>
Previous darknets, such as <a href="http://en.wikipedia.org/wiki/WASTE">WASTE</a>, have been 
...
<br>
Currently, we have insert and retrieval of arbitrarily large files ("redundant splitfiles") working,
...
<br>
Using donations through this website, the project has been able to employ one developer full-time, 
...
can contribute to our efforts, please visit our <a href="/index.php?page=donate">donations</a> page.

      <h1>Qué es Freenet?</h1>
      <blockquote>
	<i>"Estoy preocupado por mi hija y la Internet todo el tiempo, incluso cuando
	  ella es demasiado joven para haber ingresado aún. Esto es lo que me preocupa. Me
	  preocupa que dentro de 10 ó 15 años, vendrá a mí un día y dirá 'Papi,
	...
	--Mike Godwin, <a href="http://eff.org/">Electronic Frontier
      ...
      <p> 
	Freenet es software libre el cual te permite compartir archivos anónimamente, navegar 
	y publicar "freesites" (sitios web accesible solamente mediante Freenet) y discutir 
	en foros, sin temor de censura. Freenet es descentralizada para hacerla 
	...
	conectan solamente con sus, es muy difícil de detectar.
      ...
      <p>
	Las comunicaciones por los nodos Freenet están cifradas y son
	dirigidas a través de otros nodos para hacer extremadamente difícil de determinar
	...
	están cifrados, así generalmente el usuario no puede descubrir fácilmente qué hay
	en su almacén de datos, y no puede ser responsable de ellos. Foros,
	Sitios web y funcionalidades de búsqueda, son todas construidas sobre este
	almacén de datos.
      </p>
      <p>
	...
	todo el mundo incluyendo países como <a href="http://freenet-china.org">China</a> y el Medio Este
	...
	Ian Clarke, el creador de Freenet y coordinador de proyecto, fue elegido como
	...
	su vulnerabilidad, y así aún conectar a una red global a través de sus 

 <h3>Freenet Client Protocol Tools (FCPTools)</h3>
 ...
 <ul>
   ...
   </li><li>FEC inserts supported, but not FEC retrieves. 
 
   </li><li>Multithreading not supported, nor even desirable for the library itself. 
 ...
 </script><a href="mailto:Jay%20Oliveri%20%3Cilnero@gmx.net%3E">Jay Oliveri</a>.
I am currently subscribed to Freenet-dev, Freenet-tech, and
Freenet-support. On the Freenode IRC network I can be found in #freenet
...
Options:
  ...
  -f, --logfile file     Full pathname for the output log file (default stdout)
...
Options:
  ...
  -v, --verbosity num    Verbosity of log messages (default 2)
                         0=silent, 1=critical, 2=normal, 3=verbose, 4=debug
  -f, --logfile file     Full pathname for the output log file (default stdout)</pre>

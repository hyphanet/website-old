...
When you first start Freenet your node will not know other node on the network, you need to connect to other node. To find other node you can connect on irc server <big>irc.freenode.com</big> and join the room <big>#freenet</big>.

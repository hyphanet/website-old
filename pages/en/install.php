	...
	<li>Enabling a mirror copy of a Freenet installation</li>
      ...
      You can also get the Windows installer from <a href="https://checksums.freenetproject.org/latest/FreenetInstaller.exe">here</a> or <a href="https://downloads.freenetproject.org/alpha/installer/FreenetInstaller-FREENETVERSION.exe">here</a>.</p>

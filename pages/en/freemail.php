...
<p>
So do what it says. The username you create here is used to authenticate towards the Freemail-service and is only seen by you, 
...
<li>Type in the name and email address you want to use e.g. John and me@jsmith.freemail, and click Next.</li>
<li>Set the type of incoming server to IMAP and the incoming server name to localhost. Then click Next.</li>
<li>For the Incoming User Name, use the original account name you used (john in this example), which may not be the same as your email 
address name. Click Next.</li>

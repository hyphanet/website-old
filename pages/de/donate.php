...
<input type="image" src="https://www.paypal.com/images/x-click-but20.gif" border="0" name="submit"
alt="Regelmäßig per PayPal spenden">
    ...
    <table cellpadding="5" cellspacing="0" width="1%">
        <tr>
            ...
            <td align="left" width="1%">
                <input alt="Jetzt kaufen!" src="https://checkout.google.com/buttons/buy.gif?merchant_id=828420057535417&amp;w=121&amp;h=44&amp;style=white&amp;variant=text&amp;loc=de_DE" type="image"/>
            </td>
        </tr>
    </table>
...
Betrag den Sie spenden möchten:<br>USD$<input type=text 
name="PAYMENT_AMOUNT" value="20" size=4>
<input type=hidden name="PAYMENT_UNITS" value=1>in E-Gold

      ...
      est exécuté en permanence. Cela ne devrait pas avoir d'incidence
      sur les performances de votre ordinateur, puis que cela nécéssite 
      environ 200Mo de mémoire vive (RAM) et 10% de la puissance d'un 
      processeur à un coeur, ainsi que quelques accès au disque. Nous
      ...
      Freenet ne se connectera alors qu'à eux, et le fait que vous utiliser Freenet sera
      ...
      dégradées tant que vous n'ajouterez pas 10 amis ou plus qui sont souvent en ligne
	...
	c'est un Logiciel Libre ! Le code source est consultable
	librement en ligne.<br/> 
	<br/>
	...
	touchent toutes les versions précédent Java 1.5 update 4.
	Généralement, nous vous recommandons d'utiliser les dernière
	version disponible.<br/>
	Vous aurez également besoin de 'wget' pour les commandes
	...
	<p>
	  ...
	  (<a href="http://freenet.googlecode.com/files/new_installer_offline_FREENETJARVERSION.jar.sig">signature 
	    ...
	    nous recommandons les lignes de commandes ci-dessus. 
	</p>
    ...
    <h3>HOWTO</h3>  
      ...
      mal avec Freenet, Firefox et Opera peuvent (et sont) par contre être
      ...
      à votre ami, et récupérer sa référence. Ajoutez sa référence en utilisant
	...
	(Essayez <a href="http://webchat.freenode.net/?randomnick=1&channels=freenet">ici</a> pour le canal anglophone,<br/>
	<a href="http://webchat.freenode.net/?randomnick=1&channels=freenet-fr">là</a> pour le canal francophone).
      </p>
      
      <h3>Matériel requis</h3>
      <p>
      Un processeur tournant à 1GHz et 1Go de mémoire vive (RAM) devrait suffire. Freenet
      ...
      qui doit être supérieure à 100Mo. Nous recommandons au moins
      1Go.<br/>
      Freenet utilisera aussi de l'espace disque pour vos téléchargements.
      ...
      <p>
      Sur les systèmes Windows 64 bits, nous installons une machine virtuelle Java
